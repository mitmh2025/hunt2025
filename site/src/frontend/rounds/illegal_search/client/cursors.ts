...
export const default_cursor = `url('${default_cursor_image}') 28 6, auto`;
export const draggable_cursor = `url('${draggable_cursor_image}') 32 32, grabbing`;
export const dragging_cursor = `url('${dragging_cursor_image}') 32 32, grabbing`;
...
export const zoom_cursor = `url('${zoom_cursor_image}') 18 18, zoom-in`;
