    ...
    <>
      ...
      <AuthorsNoteBlock>
        ...
        <p>
          ...
          (include the phrase “CRY STOOL PIDGIN”). However, since this does not
          block any puzzle content and not completing this interaction in-person
          will prevent you from completing the finale, we strongly recommend you
