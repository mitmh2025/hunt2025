...
import { Button, ButtonSecondary, StyledSelect } from "../components/StyledUI";
...
export const ExchangeClueModal = React.forwardRef(
  function ExchangeClueModalInner(
    {
      onDismiss,
    }: {
      onDismiss: () => void;
...
export const BuyAnswerModal = React.forwardRef(function ExchangeClueModalInner(
  {
    onDismiss,
    eventsState,
  }: {
