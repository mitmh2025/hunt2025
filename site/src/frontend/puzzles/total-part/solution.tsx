...
const DROPQUOTE_4_FULL_COLORS: string[][] = [
  ...
  ...mapShorthandToColor([
    ...
    "YYYYY_.YYY.YY.YY.YYYYYYYY.YYYY_.YY.YYYYYY_YYY",
    ".YY.Y.YYYYYY.YYY.YYYYYYY_._YYYY.YYYYYYYYY_YYY",
...
const DROPQUOTE_5_FULL_COLORS: string[][] = [
  ...DROPQUOTE_5_COLORS,
  ...mapShorthandToColor([
    "RNG.NRNGNYGBR.GNR.NBGRGRN.NBGR.YG.RNG.RGGNR.G",
    "GYRYBBB.YG.RYG.BYYGYYB_._BGBR.YGYB.RYB.RYBGY.",
    "BBBY.Y.YYBYY.BYYBBYY.BYYB_.Y.BYYYBY.BB_.B_YYY",
...
const DROPQUOTE_6_FULL_COLORS: string[][] = [
  ...
  ...mapShorthandToColor([
    ...
    ".YPBPBYBPYG.BPY.BYYBBYPB.BYBBYPYYY_.YYBY.Y.BP",
