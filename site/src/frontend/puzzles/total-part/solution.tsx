  ...
  return (
    <>
      ...
      <p>
        ...
        the upper right (“northeast corner”) of the last dropquote, you can move
        1 space diagonally down, a la the king, to get to a gray knight, and
        then do a knight move to a blue U, the first color mentioned in the
        second paragraph. Follow this unique path through to spell{" "}
