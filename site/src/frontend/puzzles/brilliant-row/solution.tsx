  ...
  return (
    <>
      <p>
        ...
        Each set of lyrics is a rewritten version of a pop song that prominently
        features spelling within it. The spelled out lyrics are also obscured,
        both through the simulated static and through a number. Teams must use
        the lyrics in front of them to identify the song and the changed
        letters. When assembled in order, the changed letters provide the
        instruction <Mono>SPELL FOR US</Mono>.
      </p>
      <p>
