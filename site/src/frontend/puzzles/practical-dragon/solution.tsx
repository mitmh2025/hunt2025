...
const SOLUTION_DATA: [number, "BB" | "HM" | "WA", string, string, string][] = [
  ...
  [8, "HM", "NEW KID IN SCHOOL", "NEW KID IN TOWN", "EAGLES"],
  [9, "BB", "CHEVRE WHICH WAY BUT LOOSE", "EVERY WHICH WAY BUT LOOSE", "EDDIE RABBITT"],
  [10, "BB", "SHAKE YOUR HONEY MAKER", "SHAKE YOUR MONEYMAKER", "ELMORE JAMES"],
  [11, "HM", "DON’T GO BREAKING MY TOOTH", "DON’T GO BREAKING MY HEART", "ELTON JOHN AND KIKI DEE"],
  [12, "WA", "SHE DRIVES LIKE CRAZY", "SHE DRIVES ME CRAZY", "FINE YOUNG CANNIBALS"],
  [13, "HM", "B-B-B-BAD TO THE CHROME", "B-B-B-BAD TO THE BONE", "GEORGE THOROGOOD AND THE DESTROYERS"],
  [14, "BB", "SWEET CHILI O’ MINE", "SWEET CHILD O’ MINE", "GUNS N ROSES"],
  [15, "HM", "I AM MAMAW, HEAR ME ROAR!", "I AM WOMAN, HEAR ME ROAR!", "HELEN REDDY"],
  [16, "BB", "IN RICOTTA DA VIDA", "IN-A-GADDA-DA-VIDA", "IRON BUTTERFLY"],
  [17, "HM", "IT’S A MANNEQUIN’S WORLD", "IT’S A MAN’S MAN’S MAN’S WORLD", "JAMES BROWN"],
  [18, "WA", "LIVING WITH A HERNIA", "LIVING IN AMERICA", "JAMES BROWN"],
  [19, "WA", "I LOVE ROCKY ROAD", "I LOVE ROCK N ROLL", "JOAN JETT AND THE BLACKHEARTS"],
  [20, "BB", "PUT ME IN POACHED", "PUT ME IN COACH", "JOHN FOGERTY"],
  [21, "HM", "GOOD GOLLY, MISS DOLLY", "GOOD GOLLY, MISS MOLLY", "LITTLE RICHARD"],
  [22, "BB", "SHUT UP AND SWISS ME", "SHUT UP AND KISS ME", "MARY CHAPIN CARPENTER"],
  [23, "HM", "TORN BETWEEN TWO HANNAHS", "TORN BETWEEN TWO LOVERS", "MARY MACGREGOR"],
  [24, "WA", "THE BRADY BUNCH", "THE SAFETY DANCE", "MEN WITHOUT HATS"],
  [25, "HM", "DON’T STOP ’TIL YOU GET THE PHONE", "DON’T STOP ’TIL YOU GET ENOUGH", "MICHAEL JACKSON"],
  [26, "WA", "FAT", "BAD", "MICHAEL JACKSON"],
  [27, "WA", "PARTY IN THE CIA", "PARTY IN THE USA", "MILEY CYRUS"],
  [28, "WA", "SMELLS LIKE NIRVANA", "SMELLS LIKE TEEN SPIRIT", "NIRVANA"],
  [29, "HM", "BYE BYE BALL", "BYE BYE BYE", "NSYNC"],
  [30, "BB", "50 WAYS TO LEAVE YOUR GUAVA", "50 WAYS TO LEAVE YOUR LOVER", "PAUL SIMON"],
  [31, "HM", "ME AND RICO DOWN BY THE SCHOOLYARD", "ME AND JULIO DOWN BY THE SCHOOLYARD", "PAUL SIMON"],
  [32, "BB", "CHARBROIL FAIR", "SCARBOROUGH FAIR", "SIMON AND GARFUNKEL"],
  [33, "BB", "BABY GOT BAK CHOY", "BABY GOT BACK", "SIR MIX A LOT"],
  [34, "BB", "VIDEO KILLED THE RADICCHIO STAR", "VIDEO KILLED THE RADIO STAR", "THE BUGGLES"],
...
const HM_DATA: [number, string, string, string, string, string][] = [
  ...
  [3, "DE-DO-DO-DO, DA-DON’T-DON’T-DON’T TELL MY SECRET", "DE-DO-DO-DO, DE-DA-DA-DA IS ALL I WANT TO SAY TO YOU", "THE POLICE", "2", "H"],
  [4, "DON’T GO BREAKING MY TOOTH", "DON’T GO BREAKING MY HEART", "ELTON JOHN AND KIKI DEE", "4", "O"],
  ...
  [10, "ME AND RICO DOWN BY THE SCHOOLYARD", "ME AND JULIO DOWN BY THE SCHOOLYARD", "PAUL SIMON", "4", "L"],
  [11, "NEW KID IN SCHOOL", "NEW KID IN TOWN", "EAGLES", "4", "L"],
...
const WA_DATA: [number, string, string, string, string, string][] = [
  [1, "I LOVE ROCKY ROAD", "I LOVE ROCK N ROLL", "JOAN JETT AND THE BLACKHEARTS", "8", "T"],
