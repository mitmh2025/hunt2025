...
const RECIPES = [
  ...
  [
    ...
    "I added some rambutan to the recipe but I don’t know if I’d do that again, it stained the pan I was cooking in. I took out the eggplant and added celery instead. It sort of follows that it didn’t work well, although I guess my cat walking over the top and leaving footprints while it was cooling also probably didn’t help. 1 out of 6.",
  ],
  [
  ...
  return (
    <>
      <p>
        ...
        holidays past, with my grandfather at his chalet in the Swiss Alps.
        Winter mornings, starting a day huddled by the fireplace with a cup of
        hot chocolate. The aroma of blintzes and crepes beginning to emerge from
        his cast iron pan warming in the oven. To this day, the smell of the
        honey of wild bees smeared on toasted baguettes triggers these nascent
        memories of my youth. My grandfather at the kitchen table poring over
        his first edition copy of Swann’s Way, the rustle of the dog-eared pages
        mixing with the roar of the fire, was such pleasing music to my ears.
        It’s in the spirit of these early, halcyon days, that I now present to
        you my recipe for an excellent mixture of scrumptious ingredients sure
        to make even the grumpiest Scrooge start turning over a new leaf. The
        pleasant blend of herbs and spices begin breathing life to this loaf
        without the need for kneading. Which reminds me of the time my
        grandfather rose early and over-kneaded his holiday morning buns, and we
        sat there chewing until it was time for lunch, our jaws too tired to
        even begin to tear into the roast duck so sumptuously prepared. My
        grandfather started laughing, an uproarious sound of utter euphoria, the
        sputtering sound echoing out to snow-capped peaks. Which is why our dish
        calls for an amazing topping of shaved ice, an honor to those snowed in
        during the darkest days of the year. Early on, during those days is when
        we start to realize how important family is to us, our lives, our
        dreams, and how cooking together binds us together, the happy unity and
        synergy of our first closest bonds. You will notice a unique binder in
        the recipe, primarily tying our dough together, giving it a unique
        crumb, a crumb that lifts our preparation into the rarified air of the
        finest arts. For my grandfather was also an artist. Early on in Zurich,
        during the summers of his youth, he would display his works in the
        little bohemian café, where he one day would meet my grandmother. Sadly,
        she was taken from us too early, taken by a disease that now would be
        easily healed. That is progress for you. But we have also started to
        progress. Now, in the exact area where my grandparents spent so much of
        their time together, the kitchen. So now we unite the past and present
        in one dish in honor of their memory. A simple dish, yet one flavored
        with the nuanced affectations of familial love. But the past is past. We
        must also look to the future. I now look on my son’s son, the way my
        grandfather first looked on me as well. I hope to pass on what I have
        learned, but also try to incorporate the lessons learned by newer
        generations. So I introduce to the recipe a dash of something a man like
        my grandfather never would have dreamed of. It adds a certain pizzazz to
        this otherwise simple dish. In the kitchen at my humble ranch, nestled
        in the foothills of the Canadian Rockies, there is a picture of me and
        my grandfather, and another of me and my grandson. Starting the next few
        weeks, loaves will grace my oven–some prepared in honor of my cherished
        grandfather, some for my grandson, and some, just for me. Soon, I will
        share with you one of these recipes. Or will I? I must admit I have my
        doubts, sharing what has become such a primary, holy experience with
        you. I jest. But this loaf is holy. That’s why it’s prepared in a bundt
        pan. The increased surface area results in a more even cooking, thus a
        delectable crust. Keeping the oven at the right temperature is key. So
        it might take you a few tries to crack the crust. Each oven is unique so
        you will have to learn the ways of yours. But I’ve taken up enough of
        your time with this brief prologue. Come back next week for the actual
