...
const LaTeXFonts = createGlobalStyle`
  @font-face {
...
const UnevenAztecWrapper = styled.div`
  font-family: "Computer Modern Serif";
`;
  ...
  return (
    <>
      ...
      <UnevenAztecWrapper>
        ...
        <p>
          The ruthless, militant restriction of open access to scientific
          research is a critically important issue, not just for scholars, but
          for the entire world. In every scientific field, underpaid,
          sleep-deprived graduate students have had the experience of having
          their article rejected, wanting to see what other papers made the cut,
          and being unable to access the journal to review any other accepted
          papers. Placing research behind paywalls, avaricious admins and shady
          scientific journal editors have expended great effort to hide all but
          the first few pages of each scientific paper: flying into a rage
          because they cannot access all the journals they need to support their
          research will be very familiar to academics from smaller institutions,
          and restricting journals behind paywalls keeps the most useful parts
          of papers uninformative. Research is made inaccessible out of pure
          malice; run of the mill academics are embittered by the proliferation
          of unnecessary scientific journal paywalls. This will have
          catastrophic ramifications on the forward progress of science if the
          money grab is left unchecked; one journal CEO simply replied “Pay up,
          you [expletive] cheapskates!” when asked to comment.
        </p>
        <ButtonWrapper>
        ...
        <div>
          J. Buuren. “Negotiation Strategies to Protect Against Bargainers in
          Bad Faith” <Italics>Mystery</Italics>, vol. 718, no. 3, pp. 876-962.
        </div>
        <div>
        ...
        <div>
          ...
          Organizations” <Italics>Mystery</Italics>, vol. 718, no. 3, pp.
          876-962.
        </div>
        <div>
        ...
        <div>
          J. Apelido. “Naming Patterns in Cantonese-Speaking American
          Immigrants” <Italics>Mystery</Italics>, vol. 718, no. 3, pp. 876-962.
        </div>
        <div>
          J. Antoinette. “Hairstyles Through the Ages”{" "}
          <Italics>Mystery</Italics>, vol. 718, no. 3, pp. 876-962.
        </div>
        <div>
          J. Alter. “Comparison of Experiences of Octogenarians and
          Nonagenarians” <Italics>Mystery</Italics>, vol. 718, no. 3, pp.
          876-962.
        </div>
        <div>
        ...
        <div>
          ...
          Living Spaces” <Italics>Mystery</Italics>, vol. 718, no. 3, pp.
          876-962.
        </div>
        <div>
