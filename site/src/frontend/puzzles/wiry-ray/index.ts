...
const puzzle: PuzzleDefinition = {
  ...
  hints: [
    ...
    },
    {
      ...
      nudge:
        "Somewhere in the dungeon is a path down to the lower floors, you just have to find it.",
    },
    {
      order: 20.0,
      description:
      ...
      nudge:
        "The artifacts seem to point towards the key to the door down to the lower levels, having the coordinates of these artifacts would help immensely in making a cross with them.",
    },
    {
      order: 22.0,
      description:
