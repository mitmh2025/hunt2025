    ...
    <>
      ...
      <HScrollTableWrapper>
        <StyledTable>
          ...
          <tr>
            <td>
              “Is this get-together… entirely attended by your former
              boyfriends?” (2 5)
            </td>
            <td>Ex-party.</td>
            <td>ex parte</td>
          ...
          <tr>
            <td>
              “What made this so razor-like? The sharpener is the one who did
              it.” (7 5)
            </td>
          ...
          <tr>
            <td>
              “Attention, nation! As your pre-Hunger Games entertainment, here
              is the Knight of Perceptions!” (5 2 9)
            </td>
          ...
          <tr>
            <td>
              “You will NEVER hear me say a bad word about U2’s singer. NEVER.”
              (3 4)
            </td>
            <td>Pro-Bono.</td>
            <td>pro bono</td>
