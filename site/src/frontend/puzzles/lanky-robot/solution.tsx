    ...
    <>
      ...
      <StyledTable>
        ...
        <tbody>
          ...
          <tr>
            <td>record kept about the baem running under the hull (4 3 ⇒ 9)</td>
            <td>KEEL LOG</td>
            <td>COLLEAGUE</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>suddenly immerse a breath freshener in cold wetar (5 4 ⇒ 8)</td>
            <td>DOUSE MINT</td>
            <td>DISMOUNT</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>the version control cammond that cooks a pastry? (3 5 ⇒ 8)</td>
            <td>GIT SCONE</td>
            <td>GOATSKIN</td>
          </tr>
          <tr>
            <td>
              the entirety of a discoloration on a porsen&rsquo;s clothing (5 5
              ⇒ 9)
            </td>
            <td>WHOLE STAIN</td>
            <td>HAILSTONE</td>
          ...
          <tr>
            <td>the posterior of a small to medium sized redont (3 4 ⇒ 5 4)</td>
            <td>RAT HIND</td>
            <td>RIGHT HAND</td>
          </tr>
          <tr>
            <td>
              feli legal action in court against triplets (hopefully with cause)
              (3 5 ⇒ 3 7)
            </td>
            <td>SUE THREE</td>
            <td>SEE THROUGH</td>
