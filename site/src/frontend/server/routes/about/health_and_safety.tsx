      ...
      <>
        ...
        <ul>
          <li>
            ...
            report an encounter with a suspicious or dangerous person who is not
          ...
          <li>
            ...
            you encounter a “real-life situation” and you do not know what to do
            (minor medical issue, lost team member, encounter with police,
        ...
        <ul>
          <li>
            ...
            the only thing happening. Try not to disturb researchers, staff, and
            other activities that might be occurring on campus. Many of us are
            guests on campus, and we want to be allowed to come back.
          </li>
          <li>
            ...
            Hunt personnel explicitly provide access to. Don’t force open locked
            doors or set off emergency alarms.
          </li>
          <li>
            <strong>
        ...
        <ul>
          ...
          <li>
            ...
            <strong>plan for getting sleep</strong>. “Work until burnout” is not
            a winning strategy. Getting sleep is important—Mystery Hunt is a
            ...
            <ul>
              <li>
                ...
                dorms, hotels or nearby residences. Dorm residents hosting
                hunters should adhere to the guest policies of their residence
                halls.
              </li>
              <li>
                <strong>
                  MIT does not allow visitors to access campus between 1 AM and
                  6 AM.
                </strong>{" "}
                Non-students may not be on campus between these hours, and
                everyone (including students) must vacate your assigned team
                HQs. Our HQ will be closed and there will be no interactions or
        ...
        <ul>
          ...
          <li>
            ...
            adult present and conduct those interactions in a public environment
